...
def main(filename):
    ...
    df = _tokenize_titles_and_bodies(df)
...
def _generate_uids_for_rows(df):
    logger.info("Generating uids for articles")
    uids = (df
...
def _remove_new_lines_from_body(df):
    logger.info("Removing new lines symbols from body articles")
    stripped_body = (df
...
def _tokenize_titles_and_bodies(df):
    logger.info("Tokenizing the titles and bodies of each article")
